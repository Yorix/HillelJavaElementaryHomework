...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("list1 ASC-sorted: " + list1.toString());


        list1.sort(Direction.DESC);
        System.out.println("list1 DESC-sorted: " + list1.toString());
        ...
        System.out.println("Merge list1 + list2: " + list1.toString());
        ...
        System.out.println("Merge list3 + list4: " + list3.toString());
    }
}
